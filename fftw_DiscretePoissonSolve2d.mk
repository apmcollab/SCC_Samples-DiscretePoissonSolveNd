#
# fftw_DiscretePoissonSolve2d program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_DiscretePoissonSolve2d.cpp
INCLUDES    = -I./
INCLUDES   += -I$(SCC_Dir)
...
RELEASE_EXEC  = fftw_DiscretePoissonSolve2d.exe
DEBUG_EXEC    = fftw_DiscretePoissonSolve2d_debug.exe

RELEASE_DIR  = ./_releasefftw_DiscretePoissonSolve2d
DEBUG_DIR    = ./_debugfftw_DiscretePoissonSolve2d
